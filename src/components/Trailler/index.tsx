...
export const Trailler = ({ traillerData }: Props) => {
  return (
    <object width="100%" height="100%" className="relative h-96 min-w-full">
      <param
        name="movie"
        value={`https://www.youtube.com/embed/${traillerData.key}?html5=1&amp;rel=0&amp;hl=en_US&amp;version=3`}
      />
      ...
      <embed
        width="640"
        height="360"
        src="https://www.youtube.com/embed/yt-video-id?html5=1&amp;rel=0&amp;hl=en_US&amp;version=3"
